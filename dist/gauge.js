...
(function() {
  ...
  GaugePointer = (function(superClass) {
    ...
    GaugePointer.prototype.render = function() {
      ...
      // 아래 동그라미 그리기
      this.ctx.beginPath();
      this.ctx.arc(centerX, centerY, this.strokeWidth + 5, 0, Math.PI * 2, true);
      this.ctx.fill();
      ...
      // 글자 생성
      //this.ctx.font = "500 0.76em Gulim";
      ...
      this.ctx.beginPath();
      this.ctx.arc(centerX, centerY - 0, this.strokeWidth / 2, 0, Math.PI * 2, true);
    ...
    Gauge = (function(superClass) {
      ...
      function Gauge(canvas) {
        ...
        this.ctx.canvas.width  = canvas.parentNode.clientWidth;
